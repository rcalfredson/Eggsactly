...
class NetworkLoader:
    ...
    def init_fcrn_network(self):
        self.model_path = (
            "project/models/egg_FCRN_A_150epochs_Yang-Lab-Dell2_2021-01-06"
            + " 17-04-53.765866.pth"
        )
    ...
    def init_splinedist_network(self):
        config_path = "project/configs/unet_backbone_rand_zoom.json"
        self.model_path = (
            "project/models/splinedist_unet_full_400epochs_"
