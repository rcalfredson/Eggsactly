...
# break the images into their segments. how to know where to find the images?
# currently, does this script only work if the counts are all in the same folder?
# no, it should support multi-file.
